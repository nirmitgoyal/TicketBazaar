    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        ...
        <div className="px-6 pb-6 space-y-4">
          <h3 className="font-semibold text-lg">Available Tickets ({tickets.length})</h3>
              ...
              >
                  ...
                  <div className="flex items-center gap-3 mb-4 p-3 bg-muted/30 rounded-lg">
                    ...
                    {seller.trustScore > 0 && (
                      <div className="flex items-center gap-1">
                        ...
                        <span className="font-medium">{seller.trustScore.toFixed(0)}%</span>
                      </div>
                    )}
                  </div>
                )}
                ...
                {ticket.transferMethod && (
                  <div className="mb-4">
                    ...
                    <p className="text-sm">{ticket.transferMethod}</p>
                  </div>
                )}
